...
describe('URL Controller Tests', () => {
    ...
    describe('GET /api/url/r/:slug', () => {
        ...
        it('should return 302 for a successful redirection', async () => {
           ...
           const res = await request(app)
            ...
            const response = await request(app).get(`/api/url/r/${res.body.shortUrl}`);
        ...
        it('should return 404 if the original URL is not found', async () => {
            ...
            const response = await request(app).get('/api/url/r/someSlug');
    ...
    describe('DELETE /api/url/:id', () => {
        ...
        it('should return 200 and the deleted URL details', async () => {
            ...
            const response = await request(app).delete('/api/url/1');
